  ...
  return (
    <div className="flex justify-around items-center pb-8">
      ...
      <div className="flex flex-col gap-2">
        ...
        <p className="w-[32rem] text-zinc-400">Horizon is the annual Technical Festival of IIIT Vadodara, International Campus Diu. It is organized by the Technical Committee of IIITV - ICD and its clubs.</p>
