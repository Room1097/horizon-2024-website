...
const EventCard: React.FC<EventCardProps> = (props) => {
  ...
  return (
    <div className="border lg:w-max w-full lg:max-w-[24rem] border-gray-300 rounded-lg p-4 lg:p-[0.75rem] shadow-md flex flex-col">
      <div className="flex items-center rounded-lg overflow-hidden justify-center w-[75vw] lg:w-[19.6875rem] h-[27.8125rem] lg:h-[28rem] object-cover">
      <img src={img} alt="" className="w-[20rem] h-[31.25rem] object-contain "/>
      </div>
